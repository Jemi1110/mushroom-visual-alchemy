...
const works = [
  {
    ...
    color: "#511718" // Color secundario 1 (vino)
  },
  {
    title: "EcoVibe",
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div 
                  ...
                  style={{ backgroundColor: `${work.color}CC` }} // Agregando transparencia con CC (80%)
                >
                  <div className="text-white text-center">
                    <p className="text-sm tracking-wider">{work.category}</p>
                    <h3 className="text-2xl font-bold mt-2">{work.title}</h3>
                    <button className="mt-4 px-6 py-2 border border-white rounded-full hover:bg-white hover:text-black transition-colors">
                      Ver detalle
                    </button>
                  </div>
                </div>
